        ...
        return Task(
            description=dedent(
                ...
                **Description**: Expand the city guide into a full 7-day travel itinerary with detailed 
                per-day plans,including weather forecasts, places to eat , packing suggestions and a budget
                breakdown . you MUST suggest actual places to visit , actual hotels to stay and actual restaurants to go to
                This itinerary should cover all aspects of the trip, from arrival to departure , integrating the city guid information
        ...
        return Task(
            description=dedent(
                ...
                **Description** : Analyze and select the best city for the trip based on specific criteria such as weather patterns,
                ...
                This task involves comparing multiple cities , considering factors like current weather conditions, upcoming cultural or 
                seasonal events , and overall travel expenses.
